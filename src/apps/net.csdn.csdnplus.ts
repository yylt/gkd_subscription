      ...
      rules: [
        {
          activityIds: [
            ...
            'net.csdn.csdnplus.mvvm.ui.activity.BlogDetailActivity',
            'net.csdn.csdnplus.activity.LoginActivity',
          ],
          matches: [
            '[text*="登录" || text*="登入" || text*="注册"][visibleToUser=true]',
            '[text*="关闭" || text*="取消" || text*="暂不" || text*="跳过" || vid="iv_close" || vid="img_close" || vid="close"][visibleToUser=true]',
          ],
          snapshotUrls: [],
        },
      ],
