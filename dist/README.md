...
|CSDN|7|<li>更新提示<li>分段广告-信息流广告<li>评价提示-软件好评弹窗<li>全屏广告-弹窗广告<li>权限提示-通知权限<li>分段广告-底部广告<li>登录弹窗|
|Firefox|3|<li>全屏广告-更新提示<li>全屏广告-登录弹窗<li>全屏广告-通知提示|
|GKD|0||
...
|知乎|12|<li>开屏广告<li>分段广告-信息流广告<li>权限提示-通知权限<li>全屏广告-弹窗广告<li>局部广告-卡片广告<li>局部广告-信息流广告<li>局部广告-悬浮广告<li>更新提示<li>功能类-热榜页自动点击[展开更多]<li>功能类-自动展开回答<li>评价提示-评论区氛围评价卡片<li>全屏广告-登录弹窗|
|flomo浮墨笔记|1|<li>评价提示|
